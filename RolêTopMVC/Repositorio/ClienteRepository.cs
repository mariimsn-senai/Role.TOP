...
namespace RolêTopMVC.Repositorio
{
            public class ClienteRepository : RepositoryBaase
    {
        ...
        {
            return $"nome={cliente.Nome};idade={cliente.Idade};email={cliente.Email};telefone={cliente.Telefone};endereco={cliente.Endereco};CPF={cliente.CPF};senha={cliente.Senha};";
